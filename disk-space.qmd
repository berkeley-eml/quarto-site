...
-   [Determining usage](#howmuch)
-   [Temporary disk space](#temporary)
-   [Compression](#compression)
-   [Deleting files](#deleting)

<span id="howmuch"></span>Determining usage
-------------------------------------------
...
your request to manager@econ.berkeley.edu.
...
<span id="temporary"></span>Temporary disk space
------------------------------------------------
...
Send email to <manager@econ.berkeley.edu> to request space under
`/scratch`.
...
<span id="deleting"></span>Deleting Files
-----------------------------------------
