...
The EML consist of multi-user, macOS and Linux systems that may be
accessed remotely using either your browser (via the EML JupyterHub) or
a program which uses the secure shell (SSH) protocol. This encrypts your
data as it is transmitted over the network.
...
The list of hostnames users can access is listed on our
[dashboards](monitoring.qmd). Only Linux workstations and compute servers
allow you to view graphics/images, use the graphical user interface of
certain programs and provide desktop connections.

### <span id="windows">Connecting remotely from a Windows Computer</span>
...
<span class="small">Note: If it is the first time you connect to a
particular EML system, the SSH program will ask you if you want to
accept the new host key. Click 'Yes'.</span>
...
### <span id="mac">Connecting remotely from a macOS Computer</span>

1.  Command line access and using graphical user interface applications
2.  File Transfer
3.  Remote Desktop Access

### <span id="linux">Connecting remotely from Linux</span>
